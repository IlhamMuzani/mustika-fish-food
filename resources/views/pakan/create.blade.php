    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="{{ url('pakan') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label" for="nama">Nama *</label>
                            <input class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama"
                                type="text" placeholder="masukan nama pakan" value="{{ old('nama') }}" />
                            @error('nama')
