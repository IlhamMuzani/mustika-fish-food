              ...
              @foreach ($suppliers as $supplier)
                <tr>
                  ...
                  <td class="text-center">
                    <a href="{{ url('admin/supplier/' . $supplier->id . '/edit') }}" class="btn btn-warning">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <p>Yakin hapus supplier <strong>{{ $supplier->nama }}</strong>?</p>
                      </div>
                ...
                <div class="modal fade" id="modal-check-{{ $supplier->id }}">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                      ...
                      <div class="modal-body">
                        <p>Yakin non aktifkan client <strong>{{ $supplier->nama }}</strong>?</p>
                      </div>
                      <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                        <a href="{{ url('admin/supplier/nonaktif/' . $supplier->id) }}" class="btn btn-danger">
                          Non Aktif
                        </a>
                      </div>
                    </div>
