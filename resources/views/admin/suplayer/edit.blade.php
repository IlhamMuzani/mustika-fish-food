    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="{{ url('admin/suplayer/' . $suplayers->id) }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama"
                                type="text" placeholder="masukan nama suplayer"
                                value="{{ old('nama', $suplayers->nama) }}" />
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="isi" rows="3" placeholder="masukan alamat" name="alamat">{{ old('alamat', $suplayers->alamat) }}</textarea>
                            @error('alamat')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        </div>
