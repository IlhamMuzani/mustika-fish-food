...
@section('content')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('admin/produk') }}">Transaksi</a></li>
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      @endif
      <form action="{{ url('admin/transaksi') }}" method="post" autocomplete="off">
        @csrf
        <div class="card">
  ...
  <script>
    function getHarga(id) {
      ...
      $.ajax({
        url: "{{ url('admin/transaksi/harga') }}" + "/" + produk.value,
        type: "GET",
        dataType: "json",
