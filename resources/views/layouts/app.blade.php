  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <h4 class="nav-link">
            <span class="font-weight-bold">Selamat Datang di Mustika Fish Food</span>
          </h4>
        </li>
      </ul>
    </nav>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        <img src="{{ asset('storage/uploads/ikan.jpg') }}" alt="Mustika-Fish-Food" class="brand-image img-circle">
